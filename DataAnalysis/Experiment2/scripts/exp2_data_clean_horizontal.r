...
# Directories
input_dir  <- "C:/Users/amnesia/Desktop/RespCycles_VisuoSpatialAttention_v1_21-05-2025/Experiment2/data/raw/horizontal"
output_dir <- "C:/Users/amnesia/Desktop/RespCycles_VisuoSpatialAttention_v1_21-05-2025/Experiment2/data/processed/horizontal"
...
for (participant_id in participant_ids) {
  ...
  # Build file paths
  input_file  <- file.path(input_dir,  paste0(participant_id, "_horizontal.csv"))
  output_file <- file.path(output_dir, paste0(participant_id, "_horizontal.csv"))
